...
function save() {
    ...
    var action = "insert";
    if (invoice_details_id === "" || invoice_id === "" || stock_id === "" || qty === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'Invoice_detailsServlet',
            method: 'POST',
            data: {action: action, invoice_details_id: invoice_details_id, invoice_id: invoice_id, stock_id: stock_id, qty: qty, date_time: date_time},
...
function update() {
    ...
    } else if (invoice_details_id === "" || invoice_id === "" || stock_id === "" || qty === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'Invoice_detailsServlet',
