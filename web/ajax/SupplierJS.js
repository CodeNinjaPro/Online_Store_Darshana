...
function save() {
    ...
    var action = "insert";
    if (supplier_id === "" || name === "" || address === "" || email === "" || contact === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'SupplierServlet',
            method: 'POST',
            data: {action: action, supplier_id: supplier_id, name: name, address: address, email: email, contact: contact, date_time: date_time},
