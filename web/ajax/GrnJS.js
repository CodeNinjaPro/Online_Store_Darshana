...
function save() {
	...
	var action = "insert";
	if(grn_id === "" || stock_id === "" || supplier_id === "" || qty === "" || total === "" || date_time === ""){
		alert("Please Enter All Details")
	} else {
		$.ajax({
			url: 'GrnServlet',
			method: 'POST',
			data: {action: action, grn_id: grn_id, stock_id: stock_id, supplier_id: supplier_id, qty: qty, total: total, date_time: date_time},
...
function update() {
	...
	} else if(grn_id === "" || stock_id === "" || supplier_id === "" || qty === "" || total === "" || date_time === ""){
		alert("Please Enter All Details")
	} else {
		$.ajax({
			url: 'GrnServlet',
