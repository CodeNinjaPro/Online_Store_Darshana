    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action.equals("insert")) {
                ...
                int loyality = Integer.parseInt(request.getParameter("loyality"));
                Customer obj = new Customer();
                obj.setName(name);
                obj.setAddress(address);
                obj.setContact(contact);
                obj.setLoyality(loyality);
                ...
                try {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        String s = list.get(i).getCustomer_id() + "_" + list.get(i).getName() + "_" + list.get(i).getAddress() + "_" + list.get(i).getContact() + "_" + list.get(i).getLoyality() + "_" + list.get(i).getDate_time() + "_";
                        stringList.add(s);
                    }
