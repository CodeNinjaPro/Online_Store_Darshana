    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action.equals("insert")) {
                ...
                int loyalty_points = Integer.parseInt(request.getParameter("loyalty_points"));
                double total = Double.parseDouble(request.getParameter("total"));
                Invoice obj = new Invoice();
                obj.setCustomer_id(customer_id);
                obj.setLoyalty_points(loyalty_points);
                obj.setTotal(total);
                ...
                try {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        String s = list.get(i).getInvoice_id() + "_" + list.get(i).getCustomer_id() + "_" + list.get(i).getLoyalty_points() + "_" + list.get(i).getTotal() + "_" + list.get(i).getDate_time() + "_";
                        stringList.add(s);
                    }
