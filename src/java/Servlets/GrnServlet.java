            ...
            if (action.equals("insert")) {
                ...
                try {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        String s = list.get(i).getGrn_id() + "_" + list.get(i).getStock_id() + "_" + list.get(i).getSupplier_id() + "_" + list.get(i).getQty() + "_" + list.get(i).getTotal() + "_" + list.get(i).getDate_time() + "_";
                        stringList.add(s);
                    }
