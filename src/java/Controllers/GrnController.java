...
public class GrnController {
    ...
    public void Save(Grn data) throws Exception {
        con.getConnection();
        con.aud("INSERT INTO grn(stock_id,supplier_id,qty,total,date_time) values ('" + data.getStock_id() + "','" + data.getSupplier_id() + "','" + data.getQty() + "','" + data.getTotal() + "','" + data.getDate_time() + "') ");
    }

    public void Update(Grn data) throws Exception {
        con.getConnection();
        con.aud("UPDATE grn SET stock_id  = '" + data.getStock_id() + "',supplier_id  = '" + data.getSupplier_id() + "',qty  = '" + data.getQty() + "',total  = '" + data.getTotal() + "',date_time  = '" + data.getDate_time() + "' WHERE grn_id = '" + data.getGrn_id() + "'");
    }
